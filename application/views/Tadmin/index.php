					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Techno Creative</h5>
							</div>
					...
					<div class="card card-primary bg-primary-gradient">
						...
						<div class="card-body pb-0">
							...
							<div class="pull-in">
								...
								<canvas id="dailySalesChart" width="538" height="150" class="chartjs-render-monitor" style="display: block; width: 538px; height: 150px;"></canvas>
							</div>
						</div>
					</div>
				</div>
			...
			<footer class="footer">
				<div class="container-fluid">
						...
						<ul class="nav">
							<li class="nav-item">
								<a class="nav-link" href="">
									<i class="fab fa-github-square text-dark"></i>
									github
								</a>
							</li>
							<li class="nav-item">
					...
					<div class="copyright ml-auto">
						Made With By <a href="">Techno Creative</a>
					</div>
				</div>
			</footer>
		</div>
